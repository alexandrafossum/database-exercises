...
(4, 'Meat Loaf', 'Bat Out of Hell', 1977, 21.5, 'Hard rock, Progressive rock'),
(5, 'Whitney Houston / Various artists', 'The Bodyguard', 1992, 28.4, 'R&B, Soul, Pop, Soundtrack'),
(6, 'Eagles', 'Their Greatest Hits (1971–1975)', 1976, 32.2, 'Rock, Soft rock, Folk rock'),
(7, 'Bee Gees / Various artists', 'Saturday Night Fever', 1977, 21.6, 'Disco'),
...
(10, 'Led Zeppelin', 'Led Zeppelin IV', 1971, 29.0, 'Hard rock, Heavy metal, Folk'),
...
(16, 'Eagles', 'Hotel California', 1976, 21.5, 'Rock, Soft rock, Folk rock'),
(17, 'Various artists', 'Dirty Dancing', 1987, 17.9, 'Pop, Rock, R&B'),
(18, 'Adele', '21', 2011, 25.3, 'Pop, Soul'),
